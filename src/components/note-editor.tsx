  ...
  return (
    <div className="rounded-lg border border-zinc-200 bg-white dark:border-zinc-700 dark:bg-zinc-900">
      <div className="flex items-center gap-2 border-b border-zinc-200 px-4 py-2 dark:border-zinc-700">
        <StickyNote size={16} className="text-zinc-500 dark:text-zinc-400" />
      ...
      <textarea
        ...
        rows={3}
        className="w-full resize-y rounded-b-lg bg-transparent px-4 py-3 text-sm text-zinc-800 placeholder-zinc-400 focus:outline-none dark:text-zinc-200 dark:placeholder-zinc-500"
      />
    </div>
  );
}
